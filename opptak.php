										...
										<div class="accordion" id="accordion2">
											<div class="accordion-group">
												<div class="accordion-heading">
													...
													<h5> Frist: 4.September 23:59 </h5>
													<h6>Problemer? Kontakt bjornasm (at) stud.ntnu.no </h6>
												</div>
												
												<div id="collapseOne" class="accordion-body collapse">
													<div class="accordion-inner">
														<form class="form-horizontal" id="medlemsregistrering" name="registrering" method="POST" action="opptak.php" >
															...
															<div class="control-group">
																<label>Årskull</label>
																<div class="input-append">
																	<input type="text" name="Aarskull" id="Aarskull" placeholder="1.,2.,3.,4., eller 5. klasse">
																</div>
															</div>
															<div class="control-group">
																<label>Studieretning</label>
																<div class="input-append">
																	<input type="text" name="Studieretning" id="Studieretning" placeholder="Studieretningen din">
																</div>
															</div>
															<div class="control-group">
...
if ($_POST['Name'] || $_POST['Email'])
	{	
		...
		if (mysql_real_escape_string($_POST['Aarskull']))
		{
			$Aarskull = mysql_real_escape_string($_POST['Aarskull']);
		}
		else
		{
			$Aarskull = "tom";
		}
		if (mysql_real_escape_string($_POST['Studieretning']))
		{
			$Studieretning = mysql_real_escape_string($_POST['Studieretning']);
		}
		else
		{
			$Studieretning = "tom";
		...
		$sql="INSERT INTO Opptak (Email, Navn, Begrunnelse, Egenskaper, Timer, Annet, TLF, Aarskull, Studieretning) VALUES ('$Email', '$Navn', '$Begrunnelse', '$Egenskaper', '$Timer', '$Annet', '$TLF', '$Aarskull', '$Studieretning')";
