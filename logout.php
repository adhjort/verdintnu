...
<html lang="en">
	...
	<div class="navbar-inner">
		...
		<div class="nav-collapse collapse">
			<ul class="nav">
				<li><a href="http://www.verdintnu.no/#hjem" data-toggle="tab">Hjem</a></li>
				<li><a href="http://www.verdintnu.no/#omoss" data-toggle="tab">Om oss</a></li>
				<li><a href="http://www.verdintnu.no/#opptak" data-toggle="tab">Opptak</a></li>
			...
			<ul class="nav pull-right">
				<li><a href='http://www.verdintnu.no/#logginn' data-toggle="tab">
					Logg inn
					</a>
				</li>
			</ul>
				...
				<div class="span12">
					<div class="well well-large">
						<div class="alert alert-success">
							<h5>Du er nå logget ut, for å logge helt ut av innsida må du lukke nettleseren.</h5>
							<meta http-equiv='refresh' content='5;url=http://verdintnu.no'>
							<?php 
							Session.Clear();
Session.Abandon();
Session.RemoveAll();?>
